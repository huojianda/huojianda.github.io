webpackJsonp([1, 2], {
    34: function (n, e, t) {
        ...
        document.title += g((new Date).getFullYear() + "-" + ((new Date).getMonth() + 1) + "-" + (new Date).getDate(), "2013-07-07") + 1 + "天", e.default = {
            name: "app",
            ...
            data: function () {
                return {
                    ...
                    currentMarkdown: "",
                    fullMarkdown: "霍建达 to 卢姗姗\n----\n\n我们是在2007年相识。  \n2007年09月01日到今天。  \n已有 `" + (g((new Date).getFullYear() + "-" + ((new Date).getMonth() + 1) + "-" + (new Date).getDate(), "2007-09-01") + 1) + "` 天\n\n 2013年我们在一起.\n\n 2013年07月07日到今天。  \n已有 `" + (g((new Date).getFullYear() + "-" + ((new Date).getMonth() + 1) + "-" + (new Date).getDate(), "2013-07-07") + 1) + "` 天\n\n\n"
                }
            },
            created: function () {
                this.makeResume()
